...
@Module({
  providers: [
    ...
    {
      provide: MedicinesExitsRepository,
      useClass: PrismaMedicinesExitsRepository,
    },
    {
      provide: DispensationsMedicinesRepository,
      useClass: PrismaDispensationsMedicinesRepository,
    },
    {
    ...
    {
      provide: MovimentationRepository,
