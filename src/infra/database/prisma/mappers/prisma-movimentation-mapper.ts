...
import { Movimentation as PrismaMovimentation, type Prisma } from 'prisma/generated'
export class PrismaMovimentationMapper {
  static toDomain(raw: PrismaMovimentation): Movimentation {
    return Movimentation.create({
      ...
      dispensationId: raw.dispensationId
        ...
        : undefined,
      entryId: raw.entryId
        ? new UniqueEntityId(raw.entryId)
        : undefined,
      exitId: raw.exitId
        ? new UniqueEntityId(raw.exitId)
        : undefined,
  ...
  static toPrisma(movimentation: Movimentation): Prisma.MovimentationUncheckedCreateInput {
    return {
      ...
      dispensationId: movimentation.dispensationId?.toString(),
