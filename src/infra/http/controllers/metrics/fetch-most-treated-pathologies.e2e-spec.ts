...
describe('Fetch Most Treated Pathologies (E2E)', () => {
  ...
  test('[GET] /charts/most-treated-pathologies', async () => {
    ...
    const [exit1, exit2, exit3] = await Promise.all([
    ...
    const response = await request(app.getHttpServer())
      .get('/charts/most-treated-pathologies')
    ...
    expect(response.body.mostTreatedPathologies).toHaveLength(1);
    expect(response.body.mostTreatedPathologies[0]).toEqual(
