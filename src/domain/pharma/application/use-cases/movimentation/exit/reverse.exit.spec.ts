...
let sut: ReverseExitUseCase;

describe('Reverse Exit', () => {
  beforeEach(() => {
  ...
  it('shoult be able to reverse a exit', async () => {
    ...
    if (result.isRight()) {
      ...
      expect(inMemoryBatchStocksRepository.items[0].quantity).toBe(35);
      expect(inMemoryMedicinesStockRepository.items[0].quantity).toBe(35);
