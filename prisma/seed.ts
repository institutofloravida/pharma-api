...
async function main() {
  ...
  await prisma.stock.createMany({
    data: [{ name: 'Estoque 01', institutionId: institution.id }],
  });
    ...
    data: [
      {
        ...
        cnpj: '60659463000191',
        description:
          'O Aché busca, constantemente, novas soluções terapêuticas diferenciadas, cumprindo assim seu propósito de levar mais vida às pessoas.',
      },
    ],
  });
